...
/******/ 	return __webpack_require__(__webpack_require__.s = "./frontend/smart_todos.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
var StepForm = function (_React$Component) {
  ...
  _createClass(StepForm, [{
    ...
    value: function handleSubmit(e) {
      e.preventDefault();
      var step = Object.assign({}, this.state, { id: (0, _id_generator.uniqueId)(), title: this.state.title, todo_id: this.props.todo_id });
...
var _step_list_item_container = __webpack_require__(/*! ./step_list_item_container */ "./frontend/components/steps/step_list_item_container.jsx");

var _step_list_item_container2 = _interopRequireDefault(_step_list_item_container);

var _step_form = __webpack_require__(/*! ./step_form */ "./frontend/components/steps/step_form.jsx");
  ...
  _createClass(StepList, [{
    ...
    value: function render() {
      var _props = this.props,
          steps = _props.steps,
          todo_id = _props.todo_id,
          receiveStep = _props.receiveStep;

      var stepListItems = steps.map(function (step) {
        return _react2.default.createElement(_step_list_item_container2.default, { key: step.id, step: step });
      });
      return _react2.default.createElement(
        'div',
        null,
        ...
        _react2.default.createElement(_step_form2.default, { receiveStep: receiveStep, todo_id: todo_id })
      );
    }
  }]);
...
/***/ "./frontend/components/steps/step_list_container.jsx":
/*!***********************************************************!*\
  !*** ./frontend/components/steps/step_list_container.jsx ***!
  \***********************************************************/
/*! no static exports found */
...
var _step_list = __webpack_require__(/*! ./step_list */ "./frontend/components/steps/step_list.jsx");
...
/***/ "./frontend/components/steps/step_list_item_container.jsx":
/*!****************************************************************!*\
  !*** ./frontend/components/steps/step_list_item_container.jsx ***!
  \****************************************************************/
/*! no static exports found */
...
var _step_list_item = __webpack_require__(/*! ./step_list_item */ "./frontend/components/steps/step_list_item.jsx");
...
var _step_list_container = __webpack_require__(/*! ../steps/step_list_container */ "./frontend/components/steps/step_list_container.jsx");
...
/***/ "./frontend/components/todos/todo_detail_view_container.js":
/*!*****************************************************************!*\
  !*** ./frontend/components/todos/todo_detail_view_container.js ***!
  \*****************************************************************/
/*! no static exports found */
...
var _todo_detail_view = __webpack_require__(/*! ./todo_detail_view */ "./frontend/components/todos/todo_detail_view.jsx");
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // FORM TO ALLOW USERS TO CREATE NEW TODOS
...
var TodoForm = function (_React$Component) {
  ...
  _createClass(TodoForm, [{
    ...
    value: function handleSubmit(e) {
      e.preventDefault();
      var todo = Object.assign({}, this.state, { id: (0, _id_generator.uniqueId)(), title: this.state.title, body: this.state.body });
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { className: 'checkbox', type: 'checkbox', name: 'achievable', value: 'Achievable', required: true })
        ),
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { className: 'checkbox', type: 'checkbox', name: 'realistic', value: 'Realistic', required: true })
        ),
        _react2.default.createElement('br', null),
        _react2.default.createElement(
          'label',
...
var TodoList = function (_React$Component) {
  ...
  _createClass(TodoList, [{
    ...
    value: function render() {
      ...
      var ListOfTodos = todos.map(function (todo) {
...
var _todo_detail_view_container = __webpack_require__(/*! ./todo_detail_view_container */ "./frontend/components/todos/todo_detail_view_container.js");
...
var stepsByTodoId = exports.stepsByTodoId = function stepsByTodoId(_ref, todo_id) {
